...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadViews(){
        ...
        tvTemperatura = findViewById(R.id.textViewTemperatura);
        tvHumedad = findViewById(R.id.textViewHumedad);
        tvDescription = findViewById(R.id.textViewDescription);
        av01D = findViewById(R.id.animation_view_01d);
        av01N = findViewById(R.id.animation_view_01n);
        av02D = findViewById(R.id.animation_view_02d);
        av02N = findViewById(R.id.animation_view_02n);
        av03D = findViewById(R.id.animation_view_03d);
        av03N = findViewById(R.id.animation_view_03n);
        av04D = findViewById(R.id.animation_view_04d);
        av04N = findViewById(R.id.animation_view_04n);
        av09D = findViewById(R.id.animation_view_09d);
        av09N = findViewById(R.id.animation_view_09n);
        av10D = findViewById(R.id.animation_view_10d);
        av10N = findViewById(R.id.animation_view_10n);
        av11D = findViewById(R.id.animation_view_11d);
        av11N = findViewById(R.id.animation_view_11n);
        tvTitleTemp = findViewById(R.id.textViewTitleTemp);
        tvTitleHum = findViewById(R.id.textViewTitleHum);
    }
